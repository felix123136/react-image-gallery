...
const App = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full container mx-auto bg-almostWhite dark:bg-veryDarkGray">
        <Nav />
        ...
        {!isLoading && images?.length === 0 && <h1 className="text-5xl text-center mx-auto mt-16 pb-48 dark:text-almostWhite">No Images Found!</h1>} 
